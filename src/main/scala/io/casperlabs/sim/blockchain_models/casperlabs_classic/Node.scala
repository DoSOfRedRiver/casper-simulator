...
import io.casperlabs.sim.abstract_blockchain.{BlockchainConfig, NodeId}
...
class Node () {
//            override val ref: AgentRef,
//            stakes: Map[AgentRef, Int], // TODO: have this information in block instead
//            d: Discovery[NodeId, AgentRef],
//            g: Gossip[NodeId, AgentRef],
//            genesis: Block,
...
//      if (shouldPropose) {
//        lastProposeTime = event.scheduledDeliveryTime
//        doPropose
//      }
...
//    val diff = event.scheduledDeliveryTime - lastProposedTime
//    (diff >= delay, event.scheduledDeliveryTime + delay)
//  }
//
//  sealed trait Comm
//  object Comm {
